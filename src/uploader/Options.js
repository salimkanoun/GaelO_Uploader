        ...
        return (
            <>
                <OverlayTrigger rootClose trigger="click" placement="right" overlay={
                    ...
                    <Button variant="secondary" className='optionCog'><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-gear" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
